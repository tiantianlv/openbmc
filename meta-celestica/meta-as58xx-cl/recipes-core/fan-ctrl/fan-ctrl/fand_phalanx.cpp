...
const char *fan_path[] = {
	...
	"/sys/bus/i2c/devices/28-0050/eeprom",
	"/sys/bus/i2c/devices/29-0050/eeprom",
};
...
// #endif
	...
	for(; i < TOTAL_FANS + TOTAL_PSUS; i++)
	{
		...
		*  string "Product Part Number       : R1157-F0002-02"
		*  string "002" of "F9002" indicates direction: FAN_DIR_F2B
		*/
		if(i < TOTAL_FANS)
			sprintf(command, "fruid-util fan%d | grep R1157-F0002; echo $?", i);
		else
